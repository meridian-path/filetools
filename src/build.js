...
async function build() {
  ...
  // 5b. Per-tool "try a sample" fixtures (the Squoosh sample-input pattern)
  // -> dist/samples/<slug>/. Pre-generated by hand via
  // scripts/generate-sample-assets.js (same "not part of the plain static
  // build" treatment as og-default.png/apple-touch-icon.png above -- see
  // that script's own header comment) and committed under
  // assets/samples/<slug>/, so this step is a plain recursive copy, not
  // generation. A tool with no sampleInput field simply has no
  // assets/samples/<slug>/ directory and gets nothing copied.
  if (fs.existsSync(SAMPLES_DIR)) {
    copyDir(SAMPLES_DIR, path.join(OUT_DIR, 'samples'));
  }
