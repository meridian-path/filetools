...
test('the taxonomy is exactly the spec\'s 6-folder, 43-slug assignment (folder taxonomy/nav spec section 1.1, extended by the 2026-08-29 image family/folder addition)', () => {
  const byFolder = {};
